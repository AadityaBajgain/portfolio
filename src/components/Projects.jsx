...
const Projects = () => {
  return (
   <div id="projects" className='w-[95%] max-w-7xl flex flex-wrap gap-8 mx-auto my-10 justify-center transition-all duration-300'>
    <a href='https://github.com/AadityaBajgain/MoneyMap' className='w-[80vw] sm:w-[45%] lg:w-[30%] transition-transform duration-300 hover:scale-105'>
    ...
    <a href='https://github.com/AadityaBajgain/YT-clone' className='w-[80vw] sm:w-[45%] lg:w-[30%] transition-transform duration-300 hover:scale-105'>
